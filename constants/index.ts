...
// export const MANGO_API_URL = "http://localhost:8081/graphql";
...
export const POLICY_URL =
  "https://mangoticket-legal.nyc3.cdn.digitaloceanspaces.com/Poli%CC%81tica%20de%20Privacidad%20MT.pdf";
